...
{
   // [ContentDetailViewController share].fullscreenButton.hidden=YES;
    [self hide:YES];
}
...
- (id)init
{
    if (self = [super initWithFrame:CGRectMake(0, 0, 320, 480)])
    {
        ...
        cancelShareButton=[UIButton buttonWithType:UIButtonTypeCustom];
        cancelShareButton.frame=CGRectMake(20.0,0,40,40);
        [cancelShareButton setImage:[UIImage imageNamed:@"share-close.png"] forState:UIControlStateNormal];
        [cancelShareButton addTarget:self action:@selector(onCloseButtonTouched:) forControlEvents:UIControlEventTouchUpInside];
        [panelView addSubview:cancelShareButton];
...
- (void)sizeToFitOrientation:(UIInterfaceOrientation)orientation
{
    ...
    if (UIInterfaceOrientationIsLandscape(orientation))
    {
        ...
        cancelShareButton.frame=CGRectMake(430.0,0,40,40);
    }
    else
    {
        ...
        [indicatorView setCenter:CGPointMake(160, 240)];
        cancelShareButton.frame=CGRectMake(266.0,0,40,40);
    }
