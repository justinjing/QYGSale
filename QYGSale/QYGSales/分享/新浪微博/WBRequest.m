		...
		if ([dataDictionary count] > 0) 
		{
			for (id key in dataDictionary) 
			{
				...
				if ([dataParam isKindOfClass:[UIImage class]]) 
				{
					...
					[WBRequest appendUTF8Body:body dataString:[NSString stringWithFormat:@"Content-Type: image/png\r\nContent-Transfer-Encoding: binary\r\n\r\n"]];
					[body appendData:imageData];
				} 
				else if ([dataParam isKindOfClass:[NSData class]]) 
				{
					[WBRequest appendUTF8Body:body dataString:[NSString stringWithFormat:@"Content-Disposition: form-data; name=\"%@\"\r\n", key]];
					[WBRequest appendUTF8Body:body dataString:[NSString stringWithFormat:@"Content-Type: content/unknown\r\nContent-Transfer-Encoding: binary\r\n\r\n"]];
