...
//普通上传    
    if (postDataType == kTencentWBRequestPostDataTypeNormal){
        [TCWBRequest appendUTF8Body:body dataString:[TCWBRequest stringFromDictionary:params]];
    }
//带图片上传    
    else if (postDataType == kTencentWBRequestPostDataTypeMultipart){
...
- (void)connect{
    ...
    if ([httpMethod isEqualToString:@"POST"]){
        if (postDataType == kTencentWBRequestPostDataTypeMultipart){
