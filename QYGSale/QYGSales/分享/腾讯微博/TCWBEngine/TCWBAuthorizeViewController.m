...
//    // 授权  NSBundle *main = [NSBundle mainBundle];
...
//    [baritemCancel release];
    ...
    [button addTarget:self action:@selector(onButtonCancel) forControlEvents:UIControlEventTouchUpInside];
    ...
    webView = [[UIWebView alloc] initWithFrame:CGRectMake(0,44, 320, 420)];
