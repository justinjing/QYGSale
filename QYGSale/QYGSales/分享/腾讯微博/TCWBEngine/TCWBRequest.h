...
typedef enum{
    kTencentWBRequestPostDataTypeNone,
	kTencentWBRequestPostDataTypeNormal,		// for normal data post, such as "user=name&password=psd"
	kTencentWBRequestPostDataTypeMultipart,    // for uploading images and files.
}TecentWBRequestPostDataType;


@class TCWBRequest;

@protocol TencentWBRequestDelegate <NSObject>
...
@interface TCWBRequest : NSObject{
    ...
    NSString                *httpMethod;
    NSDictionary            *params;
    TecentWBRequestPostDataType   postDataType;
    NSDictionary            *httpHeaderFields;
    
    NSURLConnection         *connection;
    NSMutableData           *responseData;
    
    id<TencentWBRequestDelegate>   delegate;
    BOOL                    complete;
...
@property TecentWBRequestPostDataType postDataType;
@property (nonatomic, retain) NSDictionary *httpHeaderFields;
@property (nonatomic, assign) id<TencentWBRequestDelegate> delegate;
...
+ (TCWBRequest *)requestWithURL:(NSString *)url 
                 ...
                 postDataType:(TecentWBRequestPostDataType)postDataType
             httpHeaderFields:(NSDictionary *)httpHeaderFields
                     delegate:(id<TencentWBRequestDelegate>)delegate;
                  ...
                  oauth_version:(NSString *)oauth_version 
                   ...
                   postDataType:(TecentWBRequestPostDataType)postDataType
                     httpMethod:(NSString *)httpMethod 
                         params:(NSDictionary *)params
                    httpHeaderFields:(NSDictionary *)httpHeaderFields
                       delegate:(id<TencentWBRequestDelegate>)requestDelegate;
