...
#define  SegmentButtonWidth 107.0
#define  SelectionIndicatorYOffset 28.0 
...
- (CGRect)frameForSelectionIndicator {
    ...
    if (self.selectionIndicatorMode == HMSelectionIndicatorResizesToStringWidth) {
        ...
        return CGRectMake(x, SelectionIndicatorYOffset, stringWidth, self.selectionIndicatorHeight);
    } else {
        return CGRectMake(self.segmentWidth * self.selectedIndex, SelectionIndicatorYOffset, self.segmentWidth, self.selectionIndicatorHeight);
    }
}
...
- (void)updateSegmentsRects {
    ...
    if (CGRectIsEmpty(self.frame)) {
        self.segmentWidth = SegmentButtonWidth;  //每个button的宽度
